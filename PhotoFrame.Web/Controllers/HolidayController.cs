...
namespace PhotoFrame.Web.Controllers
{
    public class HolidayController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="Id,Name,HolidayType,Month,Day")] Holiday holiday)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="Id,Name,HolidayType,Month,Day")] Holiday holiday)
        {
            if (ModelState.IsValid)
            {
